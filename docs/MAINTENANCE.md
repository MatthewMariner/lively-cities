# Maintenance: after an OSRS update

How to check that the dataset still resolves against the current game cache, and what
to do when it does not. The build and run commands are in the
[README](../README.md#development); the update runbook for the Plugin Hub is
[SUBMISSION.md](SUBMISSION.md).

## Checking the dataset still resolves
