...
[![Tests](https://img.shields.io/badge/tests-572-brightgreen)](#development)
...
- **572 tests**, and every guard has been broken on purpose and watched fail. A test nobody
...
```bash
./gradlew build            # compile and run the 572 tests
