...
[![Tests](https://img.shields.io/badge/tests-569-brightgreen)](#development)
...
- **569 tests**, and every guard has been broken on purpose and watched fail. A test nobody
...
```bash
./gradlew build            # compile and run the 569 tests
