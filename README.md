...
[![Tests](https://img.shields.io/badge/tests-577-brightgreen)](#development)
...
- **577 tests**, and every guard has been broken on purpose and watched fail. A test nobody
...
```bash
./gradlew build            # compile and run the 577 tests
