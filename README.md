...
[![Tests](https://img.shields.io/badge/tests-576-brightgreen)](#development)
...
- **576 tests**, and every guard has been broken on purpose and watched fail. A test nobody
...
```bash
./gradlew build            # compile and run the 576 tests
