...
[![Tests](https://img.shields.io/badge/tests-574-brightgreen)](#development)
...
- **574 tests**, and every guard has been broken on purpose and watched fail. A test nobody
...
```bash
./gradlew build            # compile and run the 574 tests
